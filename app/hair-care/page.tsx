      ...
      <section className="home-hero">
        <div className="container home-hero__container">
          <div className="home-hero__intro">
            <p className="eyebrow">Hair Care · Adults 18+</p>
            ...
            <div className="button-row">
              ...
              <TrackedLink
                href="/how-it-works"
                eventName="cta_click"
                eventPayload={{ location: "hair_care_hero_how_it_works" }}
          ...
          <div className="hero-filmstrip" aria-label="Nidar hair-care highlights">
          ...
          <div className="hero-tabbar" role="navigation" aria-label="Hair-care sections">
            {homepageTabs.map((item, index) => (
              <TrackedAnchor
                key={item.id}
                href={`#${item.id}`}
                eventName="cta_click"
                eventPayload={{ location: "hair_care_tab", tab: item.id }}
        ...
        >
          <div className="container showcase-block__outer">
            ...
            <div className="showcase-block__copy">
              <p className="eyebrow">Hair-care module</p>
              <h2>
              ...
              <TrackedLink
                ...
                eventName="cta_click"
                eventPayload={{ location: "hair_care_showcase_cta", section: section.id }}
                className="button button--primary"
              >
                {section.ctaLabel}
              </TrackedLink>
          ...
          <div className="home-cta__shell">
            ...
            <div className="button-row">
              ...
              <TrackedLink
                href="/pricing"
                eventName="cta_click"
                eventPayload={{ location: "hair_care_bottom_cta_secondary" }}
                className="button button--secondary"
              >
                See pricing
              </TrackedLink>
